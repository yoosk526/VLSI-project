...
ort_sess = ort.InferenceSession("./model/x4_270_480.onnx", providers=['CUDAExecutionProvider'])
...
cv2.imwrite("./media/result/x4_bicubic_ku.png", bicubic)
cv2.imwrite("./media/result/x4_abpn_ku.png", srObj)
